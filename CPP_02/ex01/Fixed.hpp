...
class   Fixed {
    ...
    public:
        ...
        Fixed(const int n);//constructor de um integer
        Fixed(const float f);//constructor de um float
        ...
        float   toFloat(void) const; //fixed pra float
        int     toInt(void) const; //fixed pra int
